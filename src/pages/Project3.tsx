                  ...
                  <div className="hero-content">
                        ...
                        <div className="row">
                              <div className="col-lg-12">
                                    ...
                                    <h1 className="wow fadeInUp" data-wow-delay="1s">Capstone Title Generator</h1>
                                    
                                    <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io/Capstone-Generator/">Project Access here</a>
                                    </div>
                                    ...
                                    <div className="row">
                                          ...
                                          <div className="col-lg-4">
                                                ...
                                                <h6 className="wow fadeInUp" data-wow-delay="1.7s">10 June 2022</h6>
                                          </div>
                                    </div>
                                    <br/>
                                    <p className="wow fadeInUp" data-wow-delay="1.8s">Capstone title generator is created for Computer related course to help college to brainstorm their title for their capstone</p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div className="container">
                        ...
                        <div className="row">
                              <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div className="box">
                                    <img src = "https://bit.ly/3SFyzdZ" alt=''/>
                                </div>
                                <div className="box">
                                    <img src = "https://bit.ly/3C6kgrU" alt=''/>
                                </div>
                                <div className="box">
                                    <img src = "https://bit.ly/3Sygezj" alt=''/>
                                </div>
                              </div>
                        </div>
                  </div>
