      ...
      <div className="hero-content">
            ...
            <div className="row">
                  <div className="col-lg-12">
                        ...
                        <h1 className="wow fadeInUp" data-wow-delay="1s">Research Title Generator</h1>
                        
                        <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                              <a href="https://tianmeds.github.io/ResearchTitleGenerator/">Project Access here</a>
                        </div>
                        ...
                        <div className="row">
                              ...
                              <div className="col-lg-4">
                                    ...
                                    <h6 className="wow fadeInUp" data-wow-delay="1.5s">5 June 2022</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.7s">11 June 2022</h6>
                              </div>
                        </div>
                        <br/>
                        <p className="wow fadeInUp" data-wow-delay="1.8s">Research Title Generator for SHS Students to use in their Research Titles, similar to the Capstone Generator, except this will be available for all strands to use to generate ideas. </p>
                  </div>
            </div>
      </div>
</div>
      ...
      <div className="container">
            ...
            <div className="row">
                  <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                    <div className="box">
                        <img src = "https://bit.ly/3C3YcOB" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3CxSI06" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3C3YbKp" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3Cxlu0T" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3EnAdMS" alt=''/>
                  </div>
            </div>
      </div>
</div>
