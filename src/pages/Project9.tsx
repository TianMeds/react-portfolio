      ...
      <div className="hero-content">
            ...
            <div className="row">
                  <div className="col-lg-12">
                        ...
                        <h1 className="wow fadeInUp" data-wow-delay="1s">Calculator App</h1>
                        
                        <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                              <a href="https://tianmeds.github.io/Calculator/">Project Access here</a>
                        </div>
                        ...
                        <div className="row">
                              ...
                              <div className="col-lg-4">
                                    ...
                                    <h6 className="wow fadeInUp" data-wow-delay="1.5s">01 November 2022</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.7s">08 November 2022</h6>
                              </div>
                        </div>
                        <br/>
                        <p className="wow fadeInUp" data-wow-delay="1.8s">This calculator app is tend to increase my knowledge about Javascript and the purpose of this is to practice about my coding skills and it has also the option of Dark Mode and Light Mode</p>
                  </div>
            </div>
      </div>
</div>
      ...
      <div className="container">
            ...
            <div className="row">
                  <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                    <div className="box">
                        <img src = "https://raw.githubusercontent.com/TianMeds/Calculator/main/Dark%20Mode.jpg" alt=''/>
                    </div>
                    <div className="box">
                        <img src ="https://raw.githubusercontent.com/TianMeds/Calculator/main/Light%20Mode.jpg" alt=''/>
                    </div>
