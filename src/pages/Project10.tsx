      ...
      <div className="hero-content">
            ...
            <div className="row">
                  <div className="col-lg-12">
                        ...
                        <h1 className="wow fadeInUp" data-wow-delay="1s">Digital Clock Website</h1>
                        
                        <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                              <a href="https://tianmeds.github.io/DigitalClock/">Project Access here</a>
                        </div>
                        ...
                        <div className="row">
                              ...
                              <div className="col-lg-4">
                                    ...
                                    <h6 className="wow fadeInUp" data-wow-delay="1.5s">01 March 2022</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.7s">12 March 2022</h6>
                              </div>
                        </div>
                        <br/>
                        <p className="wow fadeInUp" data-wow-delay="1.8s">This Digital clock is also a side project for enhancing my JavaScript skills and also my front end skills</p>
                  </div>
            </div>
      </div>
</div>
      ...
      <div className="container">
            ...
            <div className="row">
                  <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                    <div className="box">
                        <img src = "https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/tianmeds.github.io_DigitalClock_.png" alt=''/>
                    </div>
                    <div className="box">
                        <img src ="https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/tianmeds.github.io_DigitalClock_%20(1).png" alt=''/>
                    </div>
