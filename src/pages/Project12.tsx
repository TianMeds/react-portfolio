                  ...
                  <div className="hero-content">
                        ...
                        <div className="row">
                              <div className="col-lg-12">
                                    ...
                                    <h1 className="wow fadeInUp" data-wow-delay="1s">Weather App</h1>
                                    
                                    <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io/weather-web-api/">Project Access here</a>
                                    </div>
                                    ...
                                    <div className="row">
                                          ...
                                          <div className="col-lg-4">
                                                ...
                                                <h6 className="wow fadeInUp" data-wow-delay="1.5s">21 January 2023</h6>
                                          </div>

                                          <div className="col-lg-4">
                                                <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 className="wow fadeInUp" data-wow-delay="1.7s">February 1 2023</h6>
                                          </div>
                                    </div>
                                    <br/>
                                    <p className="wow fadeInUp" data-wow-delay="1.8s">This Weather app is created as a side project and we use an API which weatherman.org to help us fetch some of the information. We used HTML CSS and JavaScript</p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div className="container">
                        ...
                        <div className="row">
                              <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div className="box">
                                    <img src ="https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/image_2023-02-12_130807760.png" alt=''/>
                                </div>
                                <div className="box">
                                    <img src ="https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/WeatherMockup.jpg" alt=''/>
                                </div>
                                <div className="box">
                                    <img src = "https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/Mockup-Weather.jpg" alt=''/>
                                </div>
