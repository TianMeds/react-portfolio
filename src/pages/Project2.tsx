      ...
      <div className="hero-content">
            ...
            <div className="row">
                  <div className="col-lg-12">
                        ...
                        <h1 className="wow fadeInUp" data-wow-delay="1s">Recipe Website</h1>
                        
                        <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                              <a href="https://tianmeds.github.io/ExpressEat/">Project Access here</a>
                        </div>
                        ...
                        <div className="row">
                              ...
                              <div className="col-lg-4">
                                    ...
                                    <h6 className="wow fadeInUp" data-wow-delay="1.5s">5 September 2022</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.7s">25 September 2022</h6>
                              </div>
                        </div>
                        <br/>
                    ...
                    <div className="container">
                            ...
                            <div className="row">
                                <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                    <div className="box">
                                        <img src = "https://bit.ly/3Cvhxtj" alt=''/>
                                    </div>
                                    <div className="box">
                                        <img src = "https://bit.ly/3VbBYmC" alt=''/>
                                    </div>
                                    <div className="box">
                                        <img src = "https://bit.ly/3UXVFOx" alt=''/>
                                    </div>
                                    <div className="box">
                                        <img src = "https://bit.ly/3M2j51b" alt=''/>
                                    </div>
                                    <div className="box">
                                        <img src = "https://bit.ly/3rqOdxQ" alt=''/>
                                    </div>
                                    <div className="box">
                                        <img src = "https://bit.ly/3SDtjri" alt=''/>
                                    </div>
                                    <div className="box">
                                        <img src = "https://bit.ly/3CagL3P" alt=''/>
                                    </div>
                                </div>
                            </div>
                    </div>
