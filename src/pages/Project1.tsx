      ...
      <div className="hero-content">
            ...
            <div className="row">
                  <div className="col-lg-12">
                        ...
                        <h1 className="wow fadeInUp" data-wow-delay="1s">Portfolio Website</h1>
                        
                        <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                              <a href="https://tianmeds.github.io/Portfolio/">Project Access here</a>
                        </div>
                        ...
                        <div className="row">
                              <div className="col-lg-4">
                                    ...
                                    <h6 className="wow fadeInUp" data-wow-delay="1.3s">Web Development</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.4s">started :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.5s">5 August 2022</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.7s">27 August 2022</h6>
                              </div>
                        </div>
                        <br/>
                        <p className="wow fadeInUp" data-wow-delay="1.8s">This website is created with no prior exprience in searching for some solution but it fails in developing in terms of the media queries but it developed the backend of Email and Minimalist Design with help of JavaScript</p>
                  </div>
            </div>
      </div>
</div>
      ...
      <div className="container">
            ...
            <div className="row">
                  <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                    <div className="box">
                        <img src = "https://bit.ly/3rr1mHe" alt=''/>
                    </div>
                    <div className="box">
                        <img src ="https://bit.ly/3SACb0V" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3V329vq" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3ydwTjO" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3SOCnco" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3C6s3px" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3rrvNwP" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3ruzAts" alt=''/>
                    </div>
                  </div>
            </div>
      </div>
