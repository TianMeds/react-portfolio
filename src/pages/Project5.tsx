      ...
      <div className="hero-content">
            ...
            <div className="row">
                  <div className="col-lg-12">
                        ...
                        <h1 className="wow fadeInUp" data-wow-delay="1s">Fiverr Portfolio Copy</h1>
                        
                        <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                              <a href="https://tianmeds.github.io/TianPortfolio/">Project Access here</a>
                        </div>
                        ...
                        <div className="row">
                              <div className="col-lg-4">
                                    ...
                                    <h6 className="wow fadeInUp" data-wow-delay="1.3s">Web Design</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.4s">started :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.5s">14 January 2022</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.7s">29 January 2022</h6>
                              </div>
                        </div>
                        <br/>
                        <p className="wow fadeInUp" data-wow-delay="1.8s">This is created thru the fiverr freelancing app and the owner want to developed it by own but i created a copy of mine its only a Web Design and No Backend Code</p>
                  </div>
            </div>
      </div>
</div>
      ...
      <div className="container">
            ...
            <div className="row">
                  <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                        <div className="box">
                              <img src = "https://bit.ly/3C8z0Xi" alt=''/>
                          </div>
                          <div className="box">
                              <img src = "https://bit.ly/3RHPTxS" alt=''/>
                          </div>
                          <div className="box">
                              <img src = "https://bit.ly/3EfC46t" alt=''/>
                          </div>
                          <div className="box">
                              <img src = "https://bit.ly/3rtOTCH" alt=''/>
                          </div>
                          <div className="box">
                              <img src = "https://bit.ly/3M2Qfh8" alt=''/>
                          </div>
                          <div className="box">
                              <img src = "https://bit.ly/3C9PTke" alt=''/>
                          </div>
                          <div className="box">
                              <img src = "https://bit.ly/3fDla7C" alt=''/>
                          </div>
                          <div className="box">
                              <img src = "https://bit.ly/3yePTyk" alt=''/>
                          </div>
