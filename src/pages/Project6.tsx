      ...
      <div className="hero-content">
            ...
            <div className="row">
                  <div className="col-lg-12">
                        ...
                        <h1 className="wow fadeInUp" data-wow-delay="1s">2nd Portfolio Fiverr</h1>
                        
                        <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                              <a href="https://tianmeds.github.io/SecondPortfolio/">Project Access here</a>
                        </div>
                        ...
                        <div className="row">
                              ...
                              <div className="col-lg-4">
                                    ...
                                    <h6 className="wow fadeInUp" data-wow-delay="1.5s">5 February 2022</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.7s">15 February 2022</h6>
                              </div>
                        </div>
                        <br/>
                        <p className="wow fadeInUp" data-wow-delay="1.8s">A fiverr web design for a customer that i present to see if they will like the design and make a copy for a personal look in the project section</p>
                  </div>
            </div>
      </div>
</div>
      ...
      <div className="container">
            ...
            <div className="row">
                  <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                    <div className="box">
                        <img src = "https://bit.ly/3C8AyR6" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3C5KECi" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://bit.ly/3UZ25ge" alt=''/>
                    </div>
                  </div>
            </div>
      </div>
