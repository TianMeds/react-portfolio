      ...
      <div className="hero-content">
            ...
            <div className="row">
                  <div className="col-lg-12">
                        ...
                        <h1 className="wow fadeInUp" data-wow-delay="1s">HomeCity Website</h1>
                        
                        <div className="wow fadeInUp project-link" data-wow-delay="1.1s">
                              <a href="https://0f8f1c74.homecity.pages.dev  ">Project Access here</a>
                        </div>
                        ...
                        <div className="row">
                              <div className="col-lg-4">
                                    ...
                                    <h6 className="wow fadeInUp" data-wow-delay="1.3s">Real Estate Project</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.4s">started :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.5s">May 1 2023</h6>
                              </div>

                              <div className="col-lg-4">
                                    <p className="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                    <h6 className="wow fadeInUp" data-wow-delay="1.7s">May 31 2023</h6>
                              </div>
                        </div>
                        <br/>
                        <p className="wow fadeInUp" data-wow-delay="1.8s">HomeCity Creator: Design your dream city with React - a user-friendly front-end app. Build, customize, and share without backend hassle. Create your urban masterpiece today!</p>
                  </div>
            </div>
      </div>
</div>
      ...
      <div className="container">
            ...
            <div className="row">
                  <div className="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                    <div className="box">
                        <img src ="https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/0f8f1c74.homecity.pages.dev_.png" alt=''/>
                    </div>
                    <div className="box">
                        <img src ="https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/0f8f1c74.homecity.pages.dev_%20(1).png" alt=''/>
                    </div>
                    <div className="box">
                        <img src = "https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/HomeCity%20Mockup.png" alt=''/>
                    </div>
